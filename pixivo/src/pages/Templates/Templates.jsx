...
const Templates = () => {
  ...
  const categories = [
    ...
    { id: 'dashboard', name: 'Dashboard', count: allTemplates.filter(t => t.category === 'dashboard').length },
    { id: 'ecommerce', name: 'E-commerce', count: allTemplates.filter(t => t.category === 'ecommerce').length },
    { id: 'mobile', name: 'Mobile App', count: allTemplates.filter(t => t.category === 'mobile').length },
    { id: 'landing', name: 'Landing Page', count: allTemplates.filter(t => t.category === 'landing').length },
    { id: 'portfolio', name: 'Portfolio', count: allTemplates.filter(t => t.category === 'portfolio').length },
    { id: 'blog', name: 'Blog', count: allTemplates.filter(t => t.category === 'blog').length },
